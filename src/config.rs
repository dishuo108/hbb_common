...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "mx897577".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["frp.mingxincn.com"];
pub const RS_PUB_KEY: &str = "Gk2MATd2MCQdwoK9PE8ICHYMPs+XkXwcKRnfphMJeeY=";
