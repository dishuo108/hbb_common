...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "ds183".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["18566129796.top"];
pub const RS_PUB_KEY: &str = "aKgVuptUEUvFT4BSRJ8mVmoyM9fa3l24QyNKE0bTnkw=";

pub const RENDEZVOUS_PORT: i32 = 25116;
pub const RELAY_PORT: i32 = 25117;
